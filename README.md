...
- Último marco verificado: **A1-E001 — Native precipitation scientific core** (`7dc0115`).
- Próximo marco proposto: **A1-E002 — Product Selection & Temporal Coverage**.
- A1-E002 está **proposto e ainda não autorizado**.
<!-- praxis-state:end -->
